...
def makevvwmTransfer(working_dir,
                     ...
                     deg_check, totalApp,
                     SpecifyYears, ApplicationTypes, PestAppyDay, PestAppyMon, appNumber_year, app_date_type,
    ...
    ##################################### ffList Generator ###########################################################
    myfile.write(ffListGenerator(area[0], totalApp, noofyears, PestAppyRate, localSpray[
...
def ffListGenerator(area, totalApp, noofyears, PestAppyRate, localSpray):
    ...
    localWaterAreaArray = np.empty(totalAppYears);
    localWaterAreaArray.fill(localWaterArea)
