...
def app_num_record(args):
	...
	"""
		Needs to handle 'Uniform', 'Uniform with Step', and 'Triangular' applictions. 
		Only does 'Uniform with Step' for now
	"""
	...
	if refinement == 'uniform':
		...
		return app_refine_uniform_with_step(firstapp_date_since1900, no_of_apps, args['application_rate'], args['application_method'], appfreq, args['refine_time_window1'], args['refine_percent_applied1'], args['refine_time_window2'], args['refine_percent_applied2'])
