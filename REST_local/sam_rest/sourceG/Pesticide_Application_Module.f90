...
!      !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Day_LOOP: do day = start_count, start_count+ndates-1  
            ...
            if (rain(day) > 0.) then   
                ...
                pesticide_mass_soil(day) = pesticide_mass_soil(day)+(canopy_mass-pesticide_remaining)  !for 1 compartment
                canopy_mass= pesticide_remaining 
                previous_day = day
            end if
         !*******************************************************************
             
           !need to add in harvest        
