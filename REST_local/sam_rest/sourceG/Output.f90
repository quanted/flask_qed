...
!****************************************************************
   ...
   siteID = trim(adjustl(recipe_name))
    ...
    if (toxthrestype .eq. 1) then  !30 day tox exceedances
        ...
        write(59,15) trim(adjustl(recipe_name)), mth_chronic_exceed(1),mth_chronic_exceed(2),&
              mth_chronic_exceed(3),mth_chronic_exceed(4),mth_chronic_exceed(5),mth_chronic_exceed(6),&
              mth_chronic_exceed(7),mth_chronic_exceed(8),mth_chronic_exceed(9),mth_chronic_exceed(10),&
              mth_chronic_exceed(11),mth_chronic_exceed(12),sum(mth_chronic_exceed)
15      format(A12,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5)     
    ...
    if (toxthrestype .eq. 2) then  !Annual tox exceedances
        ...
        write(59,*) "HUC, 1970, 1971, 1972, 1973, 1974, 1975, 1976, 1977, 1978, 1979, 1980, &
              1981, 1982, 1983, 1984, 1985, 1986, 1987, 1988, 1989, 1990, 1991, 1992, 1993, &
              1994, 1995, 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, &
              2007, 2008, 2009, 2010, 2011, 2012"
        write(59,17) trim(adjustl(recipe_name)), ann_chronic_exceed(1),ann_chronic_exceed(2),&
              ann_chronic_exceed(3),ann_chronic_exceed(4),ann_chronic_exceed(5),ann_chronic_exceed(6),&
              ann_chronic_exceed(7),ann_chronic_exceed(8),ann_chronic_exceed(9),ann_chronic_exceed(10),&
              ann_chronic_exceed(11),ann_chronic_exceed(12),ann_chronic_exceed(13),ann_chronic_exceed(14),&
              ann_chronic_exceed(15),ann_chronic_exceed(16),ann_chronic_exceed(17),ann_chronic_exceed(18),&
              ann_chronic_exceed(19),ann_chronic_exceed(20),ann_chronic_exceed(21),ann_chronic_exceed(22),&
              ann_chronic_exceed(23),ann_chronic_exceed(24),ann_chronic_exceed(25),ann_chronic_exceed(26),&
              ann_chronic_exceed(27),ann_chronic_exceed(28),ann_chronic_exceed(29),ann_chronic_exceed(30),&
              ann_chronic_exceed(31),ann_chronic_exceed(32),ann_chronic_exceed(33),ann_chronic_exceed(34),&
              ann_chronic_exceed(35),ann_chronic_exceed(36),ann_chronic_exceed(37),ann_chronic_exceed(38),&
              ann_chronic_exceed(39),ann_chronic_exceed(40),ann_chronic_exceed(41),ann_chronic_exceed(42),ann_chronic_exceed(43)
17      format(A12,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,&
              1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,&
              1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,1x,I5,&
              1x,I5,1x,I5,1x,I5,1x,I5)         
    end if
...
!****************************************************************
   ...
   open(UNIT= 59, FILE = trim(Outpath) // filename, RECL = (7*numcols+10))   
   write(59,*) "JulD, DailyConc(ug/L)"
   do i = 1, ndates       
       write(59,15) juliandates(i), avgconc_adj(i)*1000000.
15 format(I6,1x,E11.4)  
   end do
   close(59)
...
!*********************************************************************************************************
!Diagnostics outputs for testing purposes only, please disregard the following subroutines - mmf 6/12/14
!*********************************************************************************************************  
   ...
   if (eco_or_dw == "eco") then
     filename =  trim(adjustl(recipe_name)) // "_pestAvgConc_distrib.out"  !eco   OLD - recipe_name(14:len_trim(recipe_name)-11)
     siteID = trim(adjustl(recipe_name))
   else
   ...
   write(59,*) "Total_Leach_Mass/totalApplied: ",sum(Total_Leach_Mass)/totalApplied
   ...
   write(59,*) "JulD, Total(m3/d), Basef(m3/d), Runoff(m3/d), AvgC(ug/L), RMass(kg), LMass(kg)" !, Mass(kg), AvgConc(ug/L), Runoff(m3/d)"   !SimpleConc (ug/L)
   
   do i = 1, ndates       
       write(59,15) juliandates(i), q_adj_tot(i), baseflow(i), Total_Runoff(start_count-1+i), avgconc_adj(i)*1000000., &
              Total_Runoff_Mass(start_count+i), Total_Leach_Mass(start_count+i) 
              !rain(start_count+i), Total_Runoff(start_count+i), avgconc_adj(start_count+i)*1000000. !, conc_simple(start_count+i)*1000000.  !kg/m3->ug/L
15 format(I6,1x,E11.4,1x,E11.4,1x,E11.4,1x,E11.4,1x,E11.4,1x,E11.4)  
   end do
